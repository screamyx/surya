...
rem as surya.exe (for example --engine ws://host:27700 --engine-token ...).
rem
...
rem
rem surya.exe is a console program. It runs under a headless console host so
rem no black console window appears; its log is data\logs\surya-headed.log.
rem
...
set "SURYA_DATA_DIR=%SURYA_HOME%\data"
if not exist "%SURYA_DATA_DIR%" mkdir "%SURYA_DATA_DIR%"
set "SURYA_EXTRA_ARGS=%*"
set "SURYA_EXE=%~dp0surya.exe"
