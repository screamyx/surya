...
- Figma component **variants/properties** = our variants + sizes + the 8 states (ux-ui-expert/SKILL.md). A state that exists in code but not in the Figma variant set is a parity gap — flag it.
