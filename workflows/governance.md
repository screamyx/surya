...
3. **Design to the bar** — full spec: anatomy, variants, sizes, the 8 states, token mapping, a11y (`.claude/skills/ux-ui-expert/rules/components.md` → Component Quality Bar).
...
5. **Document & ship** — add the spec file, wire it into ux-ui-expert/SKILL.md (File Reference Map + relevant table), bump version, changelog.
...
- Maintain a single source of truth (this repo / ux-ui-expert/SKILL.md Request Router) so consumers know where to look.
...
- Is the spec at the full quality bar and wired into ux-ui-expert/SKILL.md?
