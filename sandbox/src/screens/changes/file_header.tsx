...
/// Rust: crate::icons::ALT_ARROW_DOWN / ALT_ARROW_RIGHT, from
...
/// native assets.
function chevron(collapsed: boolean) {
  return (
    <div className="flex-none size-3.5 text-text-muted/88">
      {collapsed
...
export function renderFileHeader({ file, first, collapsed, onToggleFold }: FileHeaderProps) {
  return (
