  ...
  return (
    <div className="flex-none flex flex-row items-center gap-0.5">
      <div className={props.focused
        ...
        <span className="size-3 flex-none text-text-muted">{renderBrowserIcon('magnifer')}</span>
      ...
      {step('browser-find-prev', renderBrowserIcon('arrow-up'), 'Previous match', props, false)}
      {step('browser-find-next', renderBrowserIcon('arrow-down'), 'Next match', props, true)}
