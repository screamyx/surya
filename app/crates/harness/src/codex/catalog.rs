//! Model catalog + effort mapping for Codex, ported from surya's
...
use surya_proto::{Model, ModelOption, ModelOptionChoice, ReasoningLevel, SandboxLevel};
...
/// access: surya agents fetch deps and hit APIs unattended, and with the
