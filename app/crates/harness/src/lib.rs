//! surya-harness — one interface over coding agents (plus a mock for tests).
//!
...
pub struct RunControls {
    /// The run sends questions and awaits answers (blocks the agent, mirrors surya).
...
/// the proper background-crash message old surya showed (user requirement).
