...
//!
//! In surya these were synced Postgres rows; in surya they live in the per-org
...
pub struct Device {
    ...
    /// First registration time (surya devices.created_at — the Devices page
...
pub struct Chat {
    ...
    /// continuity across engine restarts (surya's `chats.harness_session_id`).
...
pub struct Worktree {
    ...
    pub path: String,
    pub branch: String,
    /// Generated worktree folder name (`surya/<name>` is its branch).
    #[serde(default)]
    pub name: String,
