...
//!
//! Usage:
//!   cargo run -p surya-rpc --example rpc_probe -- ws://127.0.0.1:27801 LocalDevice '{}'
//!   cargo run -p surya-rpc --example rpc_probe -- ws://127.0.0.1:27801 WatchSessions '{}' --stream 3
