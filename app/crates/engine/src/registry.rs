...
use surya_harness::{Harness, HarnessError, mock::MockHarness};
use surya_proto::{AgentEvent, DoneStatus, HarnessId, ReasoningLevel, SteeringMode};
...
/// `claude-code` slot resolved through `surya_harness` on first use (subprocess
...
pub fn default_registry() -> HarnessRegistry {
    ...
    surya_harness::shell_env::prewarm();
    ...
    registry.register_lazy(
        ...
        Box::new(|| surya_harness::ClaudeHarness::new().installed()),
        Box::new(|| Ok(Arc::new(surya_harness::ClaudeHarness::new()) as Arc<dyn Harness>)),
    );
    ...
    // surya_harness::codex::catalog. CLI discovery only happens when a
    ...
    registry.register_lazy(
        ...
        Box::new(|| surya_harness::CodexHarness::new().installed()),
        Box::new(|| Ok(Arc::new(surya_harness::CodexHarness::new()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| surya_harness::CursorHarness::new().installed()),
        Box::new(|| Ok(Arc::new(surya_harness::CursorHarness::new()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| surya_harness::AcpHarness::devin().installed()),
        Box::new(|| Ok(Arc::new(surya_harness::AcpHarness::devin()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| surya_harness::AcpHarness::grok().installed()),
        Box::new(|| Ok(Arc::new(surya_harness::AcpHarness::grok()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| surya_harness::AcpHarness::hermes().installed()),
        Box::new(|| Ok(Arc::new(surya_harness::AcpHarness::hermes()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| surya_harness::AcpHarness::pi().installed()),
        Box::new(|| Ok(Arc::new(surya_harness::AcpHarness::pi()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| surya_harness::OpencodeHarness::new().installed()),
        Box::new(|| Ok(Arc::new(surya_harness::OpencodeHarness::new()) as Arc<dyn Harness>)),
    );
    registry
}
