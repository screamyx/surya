...
use gpui::{App, Global};
use surya_theme::vscode::SourceCompilation;
use surya_theme::{
...
fn reconcile_and_refresh(cx: &mut App) {
    ...
    for appearance_kind in [Appearance::Light, Appearance::Dark] {
        let model = if appearance_kind.is_light() {
            surya_theme::Appearance::Light
        } else {
            surya_theme::Appearance::Dark
        };
...
mod tests {
    ...
    fn failed_persistence_leaves_library_state_unchanged() {
        ...
        next.entries.push(CustomThemeEntry {
            ...
            source: surya_theme::CustomThemeSource::ImportedSnapshot {
                imported_from: None,
            },
            family: surya_theme::ThemeFamily {
                id: "unpersisted".into(),
                name: "Unpersisted".into(),
                variants: Vec::new(),
            },
            ...
            status: surya_theme::CustomThemeStatus::Ready,
        });
