...
//! (surya settings.devices.tsx / settings.agents.tsx / settings.archived.tsx).
...
/// title + `text-[13px]` count sharing a baseline (surya settings.devices.tsx).
...
/// Display-only toggle switch (surya branch-picker.tsx `Toggle`): an 18×32
