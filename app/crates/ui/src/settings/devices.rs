...
/// Human platform label (surya settings.devices.tsx `platformLabel`).
    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let rows: Vec<AnyElement> = devices
            ...
            .map(|(ix, device)| {
                ...
                // tone so it "cuts" the tile — surya settings.devices.tsx
                ...
                // "Added {time ago}" — always present (surya settings.devices.tsx).
                ...
                widgets::card_row(&theme, ix == 0)
                    ...
                    .child(
                        // `opacity-70 hover:opacity-100` (surya: also rises on
