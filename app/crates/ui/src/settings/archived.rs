...
impl Render for ArchivedPage {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let items: Vec<AnyElement> = rows
            ...
            .map(|(ix, chat)| {
                let title: SharedString = chat
                    ...
                    .into();
                // Unknown device → no fragment at all (surya renders the
                ...
                // surya settings.archived.tsx row: archive tile, medium title
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child({
                                ...
                                // own tone (surya: a plain span inheriting
                    ...
                    .child(
                        // Hidden until the row is hovered (surya `opacity-0
        ...
        let body: AnyElement = if items.is_empty() {
            // Centered empty state (surya settings.archived.tsx).
            div()
                .mt(px(96.0))
                .flex()
                .flex_col()
                ...
                .child(
                    ...
                    // effectively ~20% glyph (surya settings.archived.tsx).
                    crate::icons::icon(crate::icons::ARCHIVE_MINIMALISTIC)
                        .size(px(28.0))
