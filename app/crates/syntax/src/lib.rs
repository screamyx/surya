//! Syntax-highlighting contracts shared by Surya's desktop surfaces.
//!
...
fn rust_configuration() -> Result<HighlightConfiguration, HighlightError> {
    ...
    // `constant.builtin`. Surya preserves those structural roles separately.
