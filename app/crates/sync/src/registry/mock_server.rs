...
//! (`surya_doc::apply_op`). Test infrastructure only (`mock-server` feature):
//! surya-sync's client tests and surya-engine's two-engine integration tests
...
use surya_doc::{RegistryRow, RowOp, apply_op};
