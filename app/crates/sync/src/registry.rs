...
//! [`surya_doc::RegistryDoc`] under a lock. Wire frames are JSON text —
...
use surya_doc::{PendingBatch, RegistryDoc, RegistryRow, StateOutcome};
...
// ── stats (RoomStatsSnapshot-compatible so SyncStatus/`surya sync` render it) ─
