...
//!
//! ```sh
//! SURYA_EDGE_WS=ws://127.0.0.1:27640 cargo test -p surya-sync --test registry_edge -- --ignored
//! ```
...
use surya_doc::RegistryDoc;
use surya_proto::{Chat, Session, SessionStatus};
use surya_sync::RegistryClient;
...
fn edge_url(org: &str, user: &str) -> String {
    let base = std::env::var("SURYA_EDGE_WS")
        .expect("set SURYA_EDGE_WS to the edge origin, e.g. ws://127.0.0.1:27640");
...
#[tokio::test]
#[ignore = "requires a live edge: set SURYA_EDGE_WS (e.g. ws://127.0.0.1:27640)"]
