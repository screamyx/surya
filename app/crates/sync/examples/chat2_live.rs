...
//!
//! Usage:
//!   cargo run -p surya-sync --example chat2_live -- <baseUrl> <chatId> <token> <device>
//!
...
use surya_sync::SyncError;
use surya_sync::chat_client::{ChatClient, ChatDocSink, CheckpointFetcher};
